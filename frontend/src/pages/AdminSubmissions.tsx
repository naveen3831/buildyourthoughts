      ...
      <main className="lg:ml-56 flex-1 p-4 md:p-6 pt-16 lg:pt-6 min-w-0">
        ...
        <div className="flex flex-wrap gap-3 mb-6">
          <input
            ...
            className="flex-1 min-w-[200px] px-4 py-2.5 rounded-xl border-2 border-gray-200 focus:border-purple-500 focus:outline-none text-sm text-gray-900 bg-white"
          />
          <select
            value={filterStatus}
            onChange={e => setFilterStatus(e.target.value)}
            className="px-4 py-2.5 rounded-xl border-2 border-gray-200 focus:border-purple-500 focus:outline-none text-sm text-gray-900 bg-white font-medium"
          >
            {["All", "unread", "read", "replied"].map(s => <option key={s}>{s}</option>)}
          </select>
          <div className="px-4 py-2.5 rounded-xl bg-cyan-50 text-purple-700 text-sm font-bold">
                    ...
                    <td className="py-3 px-4">
                      <div className="flex gap-2 items-center">
                        <button
                          ...
                          className="px-3 py-1.5 rounded-lg bg-cyan-50 text-purple-600 text-xs font-bold hover:bg-purple-100 transition-colors"
                        >
                          View
                        </button>
                        <select
            ...
            <div className="p-6 space-y-4">
              ...
              <div>
                  ...
                  <select
                    ...
                    className="w-full px-3 py-2 rounded-xl border-2 border-gray-200 text-sm font-bold focus:border-purple-500 focus:outline-none capitalize"
                  >
                    {["unread", "read", "replied"].map(s => <option key={s}>{s}</option>)}
                  </select>
                </div>
