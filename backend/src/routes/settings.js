...
const defaults = [
  ...
  { key: "contact_email", label: "Email", value: "info@buildyourthoughts.com", group: "contact", type: "text", preserveValueUnlessMatches: ["info@buildyourthoughts.com"] },
  ...
  { key: "seo_title", label: "SEO Title", value: "BUILD YOUR THOUGHTS - Software Development & IT Solutions in Hyderabad", group: "seo", type: "text" },
  { key: "seo_description", label: "SEO Meta Description", value: "BUILD YOUR THOUGHTS is a leading software development and IT solutions company in Hyderabad, India, specializing in web/mobile apps, cloud, AI, and automation.", group: "seo", type: "textarea" },
  { key: "seo_keywords", label: "SEO Keywords", value: "software development company in hyderabad, IT services in hyderabad, web development company hyderabad, mobile app development hyderabad, cloud solutions hyderabad, AI automation hyderabad, BUILD YOUR THOUGHTS", group: "seo", type: "text" },
